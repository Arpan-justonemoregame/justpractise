...
Chainlink Local is an installable package that integrates with popular development environments like Foundry, Hardhat, and Remix. It allows you to run Chainlink services locally for rapid development and testing. For example, you can use Chainlink Local to execute CCIP cross-chain messages on a local node.
...
Seamless Integration: Compatible with Foundry, Hardhat, and Remix development environments.
...
Not supported in Remix, only on Hardhat and Foundry.
